...
namespace JWTBaseAuth.Infrastructure.Extensions
{
    public static class DbContextExtensions
    {
        ...
        private static async Task SeedAdminUserAsync(ApplicationDbContext context, IServiceProvider serviceProvider, ILogger logger)
        {
            ...
            var passwordService = serviceProvider.GetRequiredService<JWTBaseAuth.Application.Services.IPasswordService>();
